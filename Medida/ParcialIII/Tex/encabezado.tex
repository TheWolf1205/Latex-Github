...
\newcommand{\hmwkTitle}{Parcial III}
\newcommand{\hmwkDueDate}{\today}
\newcommand{\hmwkClass}{Teoría de la Medida}
...
\newcommand{\hmwkInstructor}{Guillermo Rodriguéz Blanco}
...
\newtheorem{teorema}{Teorema} % Vinculado a la sección
\newtheorem{proposicion}{Proposición} % Vinculado a la sección
\newtheorem{nota}{Nota} % Vinculado a la sección
\newtheorem{ejemplo}{Ejemplo} % Vinculado a la sección
\newtheorem{lema}{Lema} % Vinculado a la sección
\newtheorem{axioma}{Axioma} % Vinculado a la sección
\newtheorem{definicion}{Definición} % Vinculado a la sección
