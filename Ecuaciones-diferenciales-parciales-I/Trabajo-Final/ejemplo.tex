%------------------------------------------------------------------------------
% Beginning of proc_sample.tex
%------------------------------------------------------------------------------
%
% AMS-LaTeX version 2 sample file for journals, based on amsart.cls.
%
%        ***     DO NOT USE THIS FILE AS A STARTER.      ***
%        ***       USE THE PROC-L-TEMPLATE FILE.         ***
%
% Please see the README-PROC-OVERLEAF.TXT file for more information.
%
...
\title{Proceedings of the American Mathematical Society Sample}
