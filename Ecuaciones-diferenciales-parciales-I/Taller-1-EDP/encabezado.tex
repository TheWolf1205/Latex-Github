...
\newcommand{\hmwkClass}{Ecuaciones Diferenciales Parciales I}
\newcommand{\hmwkUniversity}{Universidad Nacional de Colombia}
\newcommand{\hmwkAuthorName}{Andrés David Cadena Simons \and Edgar Santiago Ochoa Quiroga \and David Felipe Viuche Malaver}
...
\title{
    ...
    \normalsize\vspace{0.1in}\small{25 de febrero del 2024}\\
