...
\begin{definition}[Grupo de Klein]
  Seja $V_4$ um grupo chamado el \textbf{grupo de Klein} caracterizado pela seguinte tabela de Cayley
  \[
  \begin{array}{c|cccc}
    \cdot & 1 & a & b & ab \\
    \hline
...
\end{notation}
\begin{note}
  Note que $V_4\cong \mathbb{Z}_{2}\times \mathbb{Z}_{2}$, alem do mais
  \begin{center}
    \input{images/v4subgrupos}  
  \end{center}
\end{note}
