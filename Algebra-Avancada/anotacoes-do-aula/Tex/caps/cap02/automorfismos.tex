...
\subsection{Automorfismos internos de um grupo}
  ...
  \end{definition}
  \begin{corollary}\label{cor:1.2.4}
    Note que se $Z(G)=\{1\}$, então $G\cong Inn(G)$.
  \end{corollary}
  \begin{proof} 
    Por causa do que foi feito na definiçao anterior, temos que $G/Z(G)\cong Inn(G)$, logo como $Z(G)=\{1\}$, temos que $G/Z(G)=G/\{1\}\cong G$, pelo que podemos conclui que $G\cong Inn(G)$.
  \end{proof}
