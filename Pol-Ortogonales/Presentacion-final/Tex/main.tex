...
\setbeamertemplate{footline}
{
  ...
  \begin{beamercolorbox}[wd=.37\paperwidth,ht=2.25ex,dp=1ex,center]{title in head/foot}%
    \usebeamerfont{title in head/foot}{Polinomios de Zernikel}
  \end{beamercolorbox}%
  \begin{beamercolorbox}[wd=.28\paperwidth,ht=2.25ex,dp=1ex,center]{date in head/foot}{Marzo 4, 2025}
...
\begin{frame}
\begin{center}
  \Huge {\color{red} Thanks for your attention.} 
\end{frame}
\begin{frame}{Board}
\end{frame}
