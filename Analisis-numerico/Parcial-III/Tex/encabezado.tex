...
\lstset{
    ...
    basicstyle=\ttfamily\small\color{black}, % Fuente monoespaciada y texto negro
    backgroundcolor=\color{white},           % Fondo blanco
    keywordstyle=\color[HTML]{0077BB}\bfseries, % Palabras clave en azul fuerte y negrita
    commentstyle=\color[HTML]{555555}\itshape, % Comentarios en gris oscuro y cursiva
    stringstyle=\color[HTML]{DD8800},        % Cadenas en naranja
    numberstyle=\tiny\color[HTML]{666666},   % Números en gris medio
    identifierstyle=\color[HTML]{333333},    % Identificadores en gris oscuro
    emph={xlabel, ylabel, title, legend, grid}, % Destaca palabras específicas
    emphstyle=\color[HTML]{117733},          % Color verde oscuro para palabras destacadas
    ...
    rulecolor=\color{black},                 % Color del borde del marco
