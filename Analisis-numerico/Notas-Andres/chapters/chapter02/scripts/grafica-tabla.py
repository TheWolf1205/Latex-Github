...
# Datos de ejemplo (ajústalos según tu tabla)
...
ax.set_xlim(-1, 12)  # Extender un poco a la izquierda
ax.set_ylim(-1, 18)  # Extender un poco debajo del origen
...
# Flechas en los ejes bien alineadas
...
# Etiquetas después de las flechas
ax.text(12.5, 0, r'$x$', fontsize=14)
ax.text(-0.5, 18, r'$y$', fontsize=14)
