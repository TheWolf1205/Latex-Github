\begin{homeworkProblem}[Seção 1-3]
  ...
  \begin{solution}
    ...
    \end{align*}
    Más note que como $P$ é partição do $A\times B$, então temos que $P=P_A\times P_B$, onde $P_A$ é uma partição de $A$ e $P_{B}$ é uma partição de $B$. Logo, dado um $K\in P$, nos podemos escrever $K=\overline{B}\times\tilde{B}$ com $\overline{B}\in P_{A}$ e $\tilde{B}\in P_{B}$, pelo que temos o seguinte
    \begin{align*}
