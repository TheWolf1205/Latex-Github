...
\begin{definition}[Diferenciabilidade entre superfícies]
  ...
  \begin{center}
    \input{images/diferenciabilidadenasuperficie2}  
  \end{center}
\end{definition}
...
\begin{definition}[Valor regular]
  Seja $f:U\to\mathbb{R}^{n-m}$ de classe $C^{k}$, com $U\subseteq \mathbb{R}^{n}$ aberto. Um ponto $c\in\mathbb{R}^{n-m}$ é \textbf{valor regular} se para todo $x\in f^{-1}(c)$, a derivada $f^{\prime}(x):\mathbb{R}^{n}\to\mathbb{R}^{m}$ é sobrejetiva. 
\end{definition}
\begin{theorem}
