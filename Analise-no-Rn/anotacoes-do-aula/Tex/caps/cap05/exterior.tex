...
\end{definition}
\begin{note}
  Em nosso caso, estamos assumindo que $\{e_1,\cdots,e_k\}$ ta contido na base canônica de $V$ e que $\{e^{1},\cdots,e^{k}\}$ ta contido na base canônica do dual $V^{\ast}$, portanto temos que
  \begin{align*}
    e^{i}(e_j)=\delta^{i}_j.
  \end{align*}
...
\begin{definition}[Multi-índice crescente]
  Dizemos que un multi-índice $I=i_1,\cdots,i_k$ é um \textbf{muli-índice crescente} se $i_1<i_2<\cdots<i_k$ com $i_r\in\{1,\cdots,n\}$ e $r\in\{1,\cdots,k\}$.
\end{definition}
Tomamos os multi-índices $I=(i_{1},\dots,i_{k})$ crescentes, isto é,
\begin{align*}
  i_{1}<i_{2}<\cdots<i_{k},
\end{align*}
pois o produto exterior é alternado. De fato, se $\sigma\in S_{k}$ é uma permutação, então
\begin{align*}
  e^{i_{\sigma(1)}}\wedge\cdots\wedge e^{i_{\sigma(k)}}=\sgn(\sigma)\,e^{i_{1}}\wedge\cdots\wedge e^{i_{k}},
\end{align*}
...
\begin{align*}
  e^{i_{1}}\wedge\cdots\wedge e^{i_{k}}=0. 
\end{align*}
